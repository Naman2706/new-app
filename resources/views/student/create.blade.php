                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('addstudent') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="percentage" type="text" class="form-control @error('percentage') is-invalid @enderror" name="percentage" value="{{ old('percentage') }}" required autocomplete="contactno" autofocus>
